...
unsigned compute_return_hash_value(const struct hash_elem *e,void *aux)
{
    int data;
    data = hash_entry(e,struct hash_item,item)->data;
    return hash_int(data);
}

bool hash_compare(const struct hash_elem *a,const struct hash_elem *b,void *aux)
{
    int hash_elem_A,hash_elem_B;

    hash_elem_A = hash_entry(a,struct hash_item,item)->data;
    hash_elem_B = hash_entry(b,struct hash_item,item)->data;

    return hash_elem_A < hash_elem_B;
}

void hash_square(struct hash_elem *a,void *aux)
{
    int square;
    square = hash_entry(a,struct hash_item,item)->data;
    hash_entry(a,struct hash_item,item)->data = square*square;
}

void hash_triple(struct hash_elem *a,void *aux)
{
    int triple;
    triple = hash_entry(a,struct hash_item,item)->data;
    hash_entry(a,struct hash_item,item)->data = triple*triple*triple;
}

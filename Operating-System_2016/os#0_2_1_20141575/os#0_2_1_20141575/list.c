...
{
    int list_elem_A,list_elem_B;
    list_elem_A = list_entry(a,struct list_item,item)->data;
    list_elem_B = list_entry(b,struct list_item,item)->data;

    return list_elem_A < list_elem_B;
}
...
void list_swap(struct list_elem *a,struct list_elem *b)
{
    ...
    struct list_elem *temp3;
    struct list_elem *temp4;
    temp1 = a->prev;
    temp2 = a->next;
    temp3 = b->prev;
    temp4 = b->next;

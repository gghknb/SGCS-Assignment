...
void CColorConversionView::OnProblem3()
{
	...
	{
		unsigned short red = (tempim16[c] >> 10) & 0x1f;
		unsigned short green = (tempim16[c] >> 5) & 0x1f;
		unsigned short blue = tempim16[c] & 0x1f;
		mg_lpImage[c] = (0.299 * red + 0.587 * green + 0.114 * blue) * 255/31;
	}
